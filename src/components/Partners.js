...
const Partners = () => {
  return (
    <div className='flex flex-col justify-center items-center'>
        <h1 className='md:text-5xl text-4xl text-white uppercase text-center py-6'><span className='text-[#892CDC]'>Technical</span> Partners</h1>
        ...
        <div>
            <h1 className='md:text-5xl text-4xl text-white uppercase text-center py-6'>
                <span className='text-[#892CDC]'>PRESS</span> ABOUT US
            </h1>
